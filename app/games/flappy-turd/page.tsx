  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 p-4 md:p-0">
      <div className="w-full mx-auto flex flex-col items-center">
        ...
        <div
          className="relative overflow-hidden border-4 border-accent2 rounded-lg shadow-xl bg-accent/5 cursor-pointer"
          style={{
        ...
        >
          ...
          {pipes.map((pipe) => (
            <div key={pipe.id}>
              <div
                className="absolute bg-accent2/50 border-4 border-t-0 border-accent2"
                style={{
              ...
              />
              <div
                className="absolute bg-accent2/50 border-4 border-b-0 border-accent2"
                style={{
                  left: pipe.x * (gameSize.width / GAME_WIDTH),
          ...
          {!isRunning && gameStarted && (
            ...
            >
              ...
              <p className="text-base md:text-xl text-white mb-4 md:mb-6">
                Your score: <span className="text-accent font-bold">{score}</span>
              </p>
              <motion.button
                onClick={resetGame}
                className="px-4 py-2 md:px-6 md:py-3 bg-accent2 text-white rounded-md text-sm md:text-lg 
                   transition-colors"
